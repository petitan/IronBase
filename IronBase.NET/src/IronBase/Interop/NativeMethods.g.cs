...
namespace IronBase.Interop
{
    ...
    // NOTE: DatabaseHandle and CollectionHandle structs are removed here
    // because they conflict with the SafeHandle wrappers in DatabaseHandle.cs
    // and CollectionHandle.cs. csbindgen generates empty structs, but we use
    // proper SafeHandle classes for resource management.
