...
static TOOL_TIMEOUTS: LazyLock<HashMap<&'static str, u64>> = LazyLock::new(|| {
    [
        ...
        ("index_list", 300_000),
        ("index_list_fulltext", 300_000),
        ("index_drop", 300_000),
        ("schema_get", 300_000),
        ("schema_set", 300_000),
        ("explain", 300_000),
        ("begin_transaction", 300_000),
        ("commit_transaction", 300_000),
        ("rollback_transaction", 300_000),
        ("transaction_status", 300_000),
        ("insert_one_tx", 300_000),
        ("update_one_tx", 300_000),
        ("delete_one_tx", 300_000),
        ("acl_list", 300_000),
        ("acl_get", 300_000),
        ("acl_set", 300_000),
        ("acl_delete", 300_000),
        ...
        ("index_create_fulltext", 300_000),
        ("index_create_fuzzy", 300_000),
        ("script_exec", 300_000),
        ("script_run", 300_000),
        ("db_compact", 300_000),
        ("db_open", 300_000),
