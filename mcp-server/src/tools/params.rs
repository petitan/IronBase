...
/// Parameters for `rag_collection_stats` / `rag_document_list` tools
#[derive(Debug, Deserialize)]
pub struct RagCollectionNameParams {
    pub name: Option<String>,
    pub collection: Option<String>,
}

impl RagCollectionNameParams {
    /// Get collection name from either 'name' or 'collection' field
    pub fn get_name(&self) -> Option<&str> {
        self.name.as_deref().or(self.collection.as_deref())
    }
}

/// Parameters for `rag_collection_delete` tool
#[derive(Debug, Deserialize)]
pub struct RagCollectionDeleteParams {
    pub name: String,
    pub admin_key: Option<String>,
}
...
/// Parameters for `rag_document_delete` tool
#[derive(Debug, Deserialize)]
pub struct RagDocumentDeleteParams {
    pub collection: String,
    pub doc_id: String,
}
